...
foldersTree = gFld("<i>Treeview Demo</i>", "demoFramesetRightFrame.html")
  ...
  aux1 = insFld(foldersTree, gFld("Photos example", "demoFramesetRightFrame.html"))
    ...
    aux3 = insFld(aux2, gFld("GUI", "http://www.treeview.net/treemenu/demopics/beenthere_america.gif"))
      insDoc(aux3, gLnk("R", "JOAO", "http://www.treeview.net/treemenu/demopics/beenthere_boston.jpg"))
      insDoc(aux3, gLnk("R", "MARI", "http://www.treeview.net/treemenu/demopics/beenthere_newyork.jpg"))
      insDoc(aux3, gLnk("R", "VICKY", "http://www.treeview.net/treemenu/demopics/beenthere_washington.jpg"))
