...
// ***************************************************************** 
function Folder(folderDescription, hreference, popUp) //constructor 
{ 
  this.popUp = popUp;
...
{ 
  ...
  { 
	if (this.popUp)
	{
	  //docW = docW + "<a href='" + this.popUp + this.hreference + "' TARGET=\"basefrm\" "
	  docW = docW + "<a href=javascript:popUp('" + this.hreference + "',250,250); TARGET=\"basefrm\" "
	}
	else if (USEFRAMES)
	{
...
function gFld(description, hreference, popUp) 
{ 
  folder = new Folder(description, hreference, popUp);
  return folder;
} 
